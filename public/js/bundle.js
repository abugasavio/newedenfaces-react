...
var FooterActions = function () {
    ...
    _createClass(FooterActions, [{
        ...
        value: function getTopCharacters() {
            ...
            $.ajax({ url: '/api/charactets/top' }).done(function (data) {
...
},{"./AddCharacter":5,"./Footer":7,"./Navbar":9,"react":"react"}],7:[function(require,module,exports){
'use strict';
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'a',
                  { href: 'https://github.com/savioabuga/newedenfaces' },
                  'Source Code'
                ),
